...
export interface ColumnsBase<T extends UTableCommonItemBase> {
   ...
   * 自定义渲染
   */
  render?: (row: T, index?: number, instance?: UTableMethods<T>) => React.ReactElement
}
...
export type ElementCustomRendered<T extends UTableCommonItemBase> = (columnData: ColumnsBase<T>) => React.ReactElement
